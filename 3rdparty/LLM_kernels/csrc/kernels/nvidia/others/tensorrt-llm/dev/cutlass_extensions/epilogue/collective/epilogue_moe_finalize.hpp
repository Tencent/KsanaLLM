...
class EpilogueMoeFusedFinalize {
 public:
  ...
  CUTLASS_HOST_DEVICE void operator()(ProblemShapeMNKL problem_shape_mnkl, BlockShapeMNK blk_shape_MNK,
    ...
    auto read_scatter_map = llm_kernels::nvidia::tensorrt_llm::dev::cutlass_extensions::IndexedGather(
    ...
    Tensor mD_mnl = llm_kernels::nvidia::tensorrt_llm::dev::cutlass_extensions::make_gather_tensor(
