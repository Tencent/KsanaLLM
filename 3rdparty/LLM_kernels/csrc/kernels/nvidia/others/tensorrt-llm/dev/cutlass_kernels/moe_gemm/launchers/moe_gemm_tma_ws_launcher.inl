...
#include "csrc/kernels/nvidia/others/tensorrt-llm/dev/cutlass_extensions/epilogue/collective/epilogue_moe_finalize.hpp"
...
void tma_warp_specialized_generic_moe_gemm_kernelLauncher(TmaWarpSpecializedGroupedGemmInput tma_ws_input,
                                                          int num_experts, int const multi_processor_count,
  ...
  if constexpr (ArchTag::kMinComputeCapability < 90) {
    ...
    return DispatchToTmaWSFunction<ArchTag, T, WeightType, OutputType, EpilogueTag, FUSION, TileShape, ClusterShape,
                                   IsMXFPX, BIAS>::op(tma_ws_input, num_experts, multi_processor_count, stream,
...
#define INSTANTIATE_TMA_WARP_SPECIALIZED_MOE_GEMM(ArchTag_, DataType_, WeightType_, OutputType_, EpilogueTag_,                                                                                                                              \
                                                  FUSION_, CTA_M_, CTA_N_, CTA_K_, CGA_M_, CGA_N_, CGA_K_, MXFPX_,                                                                                                                          \
                                                  BIAS_)                                                                                                                                                                                    \
  static void                                                                                                                                                                                                                               \
    ...
    using EpilogueTag = llm_kernels::nvidia::tensorrt_llm::dev::cutlass_extensions::EpilogueTag_;                                                                                                                                           \
    ...
    if constexpr (!COMPILE_HOPPER_TMA_GROUPED_GEMMS_ENABLED && ArchTag::kMinComputeCapability >= 90 &&                                                                                                                                      \
      ...
      constexpr static int AlignmentB =                                                                                                                                                                                                     \
          IsWFP4AFP8 ? 128 : (128 / cutlass::sizeof_bits<ElementB>::value); /* Memory access granularity/alignment of                                                                                                                       \
                                                                           B matrix in units                                                                                                                                                                                                                                      \
      ...
      constexpr static int AlignmentC =                                                                                                                                                                                                     \
          128 / cutlass::sizeof_bits<ElementType>::value; /* Memory access granularity/alignment of C matrix in                                                                                                                             \
                                                          // units of elements (up to 16 bytes)*/                                                                                                                                           \
                                                                                                                                                                                                                                            \
      ...
      static_assert(                                                                                                                                                                                                                        \
          cutlass::platform::is_same<                                                                                                                                                                                                       \
              EpilogueTag, llm_kernels::nvidia::tensorrt_llm::dev::cutlass_extensions::EpilogueOpDefault>::value,                                                                                                                           \
      ...
      using CollectiveEpilogueFinalize = typename cutlass::epilogue::collective::                                                                                                                                                           \
          EpilogueMoeFusedFinalizeBuilder<                         /**/                                                                                                                                                                     \
                                          ...
                                          ElementFinalOutput,                                                                                                                                                                               \
                                          TmaWarpSpecializedGroupedGemmInput::FusedFinalizeEpilogue::                                                                                                                                       \
                                              StrideFinalOutput, /**/                                                                                                                                                                       \
                                          ElementAccumulator,    /**/                                                                                                                                                                       \
                                          ElementAccumulator,    /**/                                                                                                                                                                       \
                                          ElementBias,                                                                                                                                                                                      \
                                          TmaWarpSpecializedGroupedGemmInput::FusedFinalizeEpilogue::StrideBias, /**/                                                                                                                       \
                                          ElementRouterScales,                                                                                                                                                                              \
                                          TmaWarpSpecializedGroupedGemmInput::FusedFinalizeEpilogue::                                                                                                                                       \
                                              StrideRouterScales /**/                                                                                                                                                                       \
                                          >::CollectiveOp;                                                                                                                                                                                  \
                                                                                                                                                                                                                                            \
      using CollectiveEpilogue = std::conditional_t<FUSION == EpilogueFusion::FINALIZE, CollectiveEpilogueFinalize,                                                                                                                         \
      ...
      using KernelSchedule = std::conditional_t<IsBlackwell, KernelScheduleBW, KernelScheduleSM90>;                                                                                                                                         \
                                                                                                                                                                                                                                            \
      using TensorOp = std::conditional_t<IsBlackwell && IsBlockScaled, cutlass::arch::OpClassBlockScaledTensorOp,                                                                                                                          \
      ...
      if (kernel_occupancy != nullptr) {                                                                                                                                                                                                    \
        KLLM_KERNEL_THROW("TMA WS kernels do not support calculating occupancy");                                                                                                                                                           \
        return;                                                                                                                                                                                                                             \
      }                                                                                                                                                                                                                                     \
                                                                                                                                                                                                                                            \
      ...
      KLLM_KERNEL_CHECK(tma_ws_input.stride_a);                                                                                                                                                                                             \
      KLLM_KERNEL_CHECK(tma_ws_input.stride_b);                                                                                                                                                                                             \
      KLLM_KERNEL_CHECK(tma_ws_input.ptr_a);                                                                                                                                                                                                \
      KLLM_KERNEL_CHECK(tma_ws_input.ptr_b);                                                                                                                                                                                                \
                                                                                                                                                                                                                                            \
      ...
      auto make_epilogue_scalars = [&]() {                                                                                                                                                                                                  \
        if constexpr (IsBlackwell) {                                                                                                                                                                                                        \
          return construct_if_true<IsBlackwell, EpilogueScalars>(                                                                                                                                                                           \
              ElementAccumulator(1.f), tma_ws_input.ptr_c ? ElementAccumulator(1.f) : ElementAccumulator(0.f),                                                                                                                              \
              nullptr, nullptr, tma_ws_input.alpha_scale_ptr_array, nullptr,                                                                                                                                                                \
      ...
      auto make_epi_args = [&]() {                                                                                                                                                                                                          \
        ...
        if constexpr (FUSION == EpilogueFusion::NONE) {                                                                                                                                                                                     \
          ...
          return construct_if_true<FUSION == EpilogueFusion::NONE, EpilogueArguments>(                                                                                                                                                      \
              epilogue_scalars, nullptr, tma_ws_input.stride_c, reinterpret_cast<ElementD**>(epi_params.ptr_d),                                                                                                                             \
              epi_params.stride_d);                                                                                                                                                                                                         \
          ...
          return construct_if_true<FUSION == EpilogueFusion::FINALIZE, EpilogueArguments>(                                                                                                                                                  \
              ...
              reinterpret_cast<ElementBias const*>(epi_params.ptr_bias), epi_params.stride_bias, /* Bias params */                                                                                                                          \
      ...
      KLLM_KERNEL_CHECK_WITH_INFO(calculated_ws_size <= tma_ws_input.gemm_workspace_size,                                                                                                                                                   \
      ...
      auto run_status = gemm.run(stream, nullptr, llm_kernels::nvidia::tensorrt_llm::dev::common::getEnvEnablePDL());                                                                                                                       \
  ...
  struct DispatchToTmaWSFunction<                                                                                                                                                                                                           \
      ...
      llm_kernels::nvidia::tensorrt_llm::dev::cutlass_extensions::EpilogueTag_, EpilogueFusion::FUSION_,                                                                                                                                    \
