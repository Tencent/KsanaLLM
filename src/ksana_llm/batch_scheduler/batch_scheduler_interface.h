...
class BatchSchedulerInterface {
 public:
  ...
  virtual std::shared_ptr<ScheduleOutputGroup> Schedule(size_t pp_batch_idx) = 0;
  ...
  virtual bool IsIdle(size_t pp_batch_idx) = 0;

  virtual void WaitUntilHaveReqs(size_t pp_batch_idx) = 0;
